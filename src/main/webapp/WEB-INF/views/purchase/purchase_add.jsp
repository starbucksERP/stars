	...
	<div class="row">
		<div class="sidebar">
			...
			<div class="information">
				<table class="table">
					<thead>
						...
						<tr>
							<th>구매단가</th>
							<td>￦<span id="itemPprice"></span></td>
							<th>수량</th>
							<td colspan="3"><input type="number" id="orderQty"/>  &nbsp;개 <input type="hidden" id="itemPprice" /></td>
						</tr>
					</thead>
				</table>
			...
			<div class="information">
				...
				<div class="center">
					<button type="button" class="a-button big" id="purchaseOrderInput" >발주 입력</button>
...
<script type="text/javascript">
	...
	$(".addTr").click(function() {
		...
		var html="<tr>"+
			...
			"<td><span style='text-align:center;' class='storeId' value='9999'>"+$('#storeId').val()+"</span></td>"+
			...
			"<td>￦<span style='text-align:center; ' class='itemPprice'>"+$('#itemPprice').text()+"</span></td>"+
			"<td>￦<span style='text-align:center; '>"+($('#orderQty').val()*$('#itemPprice').text())+"</span></td>"+
		"</tr>";
	...
	$("#CategoryListOption").change(function() {
		...
		$.ajax({
			...
			success: function(json) {
				...
				$("#itemPprice").text(json.itemPprice);
			},
			error: function(xhr) {
				alert("에러코드 = "+xhr.status)
			}
